                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h3>
                                ...
                                @if($order_data->item && $order_data->item->user_type == 'merchant' && $order_data->item->user_id == Session::get('login_merchant_59ba36addc2b2f9401580f014c7f58ea4e30989d') )
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                           <table id="example1" class="table table-bordered table-striped">
                                ...
                                @if($order_view->item->user_type == 'merchant' && $order_view->item->user_id == Session::get('login_merchant_59ba36addc2b2f9401580f014c7f58ea4e30989d') )
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if($order_view->item->user_id == $merchant->id && $order_view->item->user_type == 'merchant')
                                                {{$merchant->first_name}}
                                                @endif
                                                @endforeach

                                                @foreach($admins as $admin)
                                                @if($order_view->item->user_id == $admin->id && $order_view->item->user_type == 'admin')
                                                {{$admin->name}}
                                                @endif
                                                @endforeach
                                            </td>
